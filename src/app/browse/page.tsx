  ...
  const fetchResults = useCallback(
    async (append = false, currentOffset = 0) => {
      ...
      try {
        ...
        // non-critical 窶・leave existing results in place
      } finally {
        setLoading(false)
      }
    },
    ...
    <div className="max-w-6xl mx-auto space-y-5">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          {loading && items.length === 0 ? 'Loading窶ｦ' : totalLabel || 'Discover your next favourite read'}
        </p>
      </div>
      ...
      <form onSubmit={handleSearchSubmit} className="relative">
        ...
        <input
          type="text"
          placeholder="Search titles, authors窶ｦ"
          value={query}
      ...
      {loading && items.length === 0 ? (
        ...
        <div className="text-center py-16">
          <div className="text-5xl mb-4">答</div>
                ...
                <div className="aspect-[2/3] relative rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800 mb-2 shadow-sm">
                  {work.coverImage ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-700 dark:to-gray-800">
                      <span className="text-4xl">当</span>
                    </div>
                  )}
