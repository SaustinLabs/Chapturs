...
import { BookOpen, Search, FileText, Loader2, Plus, TrendingUp } from 'lucide-react'
...
export default function CreatorGlossaryPage() {
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Manage chapter-aware definitions for your stories
        </p>
      </div>
      ...
      {filteredWorks.length === 0 ? (
          ...
          {works.length === 0 ? (
            <>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Upload your first story to start managing glossary terms.
              </p>
              <Link 
                href="/creator/upload"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredWorks.map((work) => (
            <Link
              key={work.id}
              href={`/creator/works/${work.id}/glossary`}
              className="group"
            >
              <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-lg transition-all">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="flex items-center gap-1">
                      <FileText size={14} />
                      <span>{work._count?.glossaryTerms || 0} terms</span>
                    </div>
                  </div>
                </div>
              </div>
